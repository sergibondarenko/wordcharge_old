          ...
          <form name="form1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]).'?myLang='.$myLang;?>">
            ...
            <table id="mainTableIn">
              ...
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td><input class="btn btn-default btn-md" type="submit" name="Submit" value="<?php echo $langArray["textSignup"]; ?>"></td>
              </tr>
              <tr>
                <td></td>
                <td></td>
              ...
              <form class="form-horizontal" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]).'?myLang='.$myLang;?>">
                <fieldset>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-10">
                      <input type="password" class="form-control" name="myemail" type="email" id="myemail" placeholder="E-Mail">
                    </div>
                  </div>
                  <div class="form-group">
